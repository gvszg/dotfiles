...
let g:vim_bootstrap_langs = "c,go,html,javascript,ocaml,python,ruby"
...
"" deoplete.nvim: extensible and asynchronous completion framework for neovim/Vim8
if has('nvim')
...
" html
" for html,xml,eruby,css,scss files, 4 spaces
...
autocmd Filetype yaml,snippets setlocal ts=2 sts=2 sw=2
